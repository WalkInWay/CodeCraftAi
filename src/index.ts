        ...
        try {
            ...
            while (true) {
                ...
                if (message instanceof ServerMessage.GetAction) {
                    await (new ClientMessage.ActionMessage(await strategy.getAction(message.playerView, message.debugAvailable ? debugInterface : null)).writeTo(this.streamWrapper));
